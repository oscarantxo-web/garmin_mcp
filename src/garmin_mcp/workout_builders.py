...
EXERCISE_MAP = {
    ...
    "peso muerto rumano con barra": ("DEADLIFT", "BARBELL_ROMANIAN_DEADLIFT"),
    "peso muerto rumano barra": ("DEADLIFT", "BARBELL_ROMANIAN_DEADLIFT"),
    "barbell romanian deadlift": ("DEADLIFT", "BARBELL_ROMANIAN_DEADLIFT"),
    "peso muerto rumano con mancuernas": ("DEADLIFT", "DUMBBELL_ROMANIAN_DEADLIFT"),
    "peso muerto rumano mancuernas": ("DEADLIFT", "DUMBBELL_ROMANIAN_DEADLIFT"),
    "dumbbell romanian deadlift": ("DEADLIFT", "DUMBBELL_ROMANIAN_DEADLIFT"),
    "peso muerto rumano": ("DEADLIFT", "BARBELL_ROMANIAN_DEADLIFT"),
    "romanian deadlift": ("DEADLIFT", "BARBELL_ROMANIAN_DEADLIFT"),
    "rdl": ("DEADLIFT", "BARBELL_ROMANIAN_DEADLIFT"),
    "peso muerto piernas rigidas": ("DEADLIFT", "BARBELL_STRAIGHT_LEG_DEADLIFT"),
    "peso muerto piernas rígidas": ("DEADLIFT", "BARBELL_STRAIGHT_LEG_DEADLIFT"),
    "straight leg deadlift": ("DEADLIFT", "BARBELL_STRAIGHT_LEG_DEADLIFT"),
